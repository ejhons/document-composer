...
from engine.src.doc_engine.execution.engine import DocumentEngine
from engine.src.doc_engine.models.manifest import AssembledManifest
...
class DocumentPipeline:
    ...
    def __init__(
            self, 
            manifest_path: str,
            output_root: str = "engine/src/doc_engine/output"
            ):
    ...
    # TODO: Realizar injeção de dependência
    ...
    def run(
        ...
        try:
            ...
            compiler.compile(
                source_markdown_path=dist_markdown_path, 
